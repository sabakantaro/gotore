...
ActiveRecord::Schema[7.0].define(version: 2023_01_21_084849) do
  ...
  create_table "events_favorites", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "user_id", default: 0, null: false
    t.integer "event_id", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_id"], name: "index_events_favorites_on_event_id"
    t.index ["user_id"], name: "index_events_favorites_on_user_id"
  end
  ...
  create_table "participates", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "users_evaluations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "evaluated_id"
    t.integer "evaluator_id"
    t.float "evaluation"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["evaluated_id"], name: "index_users_evaluations_on_evaluated_id"
    t.index ["evaluator_id"], name: "index_users_evaluations_on_evaluator_id"
  end
